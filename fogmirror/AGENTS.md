...
13. **Trail width must sit below the drop's own radius, not above it.** The anti-staircase floor was wider than any drop this produces, so every streak came out the same width and three times fatter than its head. Lower the floor, and carry the visible difference in how wet the track is left — which scales with the head's mass. See PHYSICS.md §12b.
